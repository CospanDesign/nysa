...
4.Makefile: MAIN CONTROL point
	...
	-'make wave': opens up GTK wave and runs the "wave_script.tcl" in order to
    load the signals, feel free to mofiy this file in order to view your own
    signals
	-'make clean': clean everythin up

5. file_list.txt: a list of files that are fed into the Makefile to generate
